...
//          }
    ...
    public static void mainn() {
        ...
        sendmail.setUserName("wangyedongman@163.com");
        sendmail.setPassWord("******");//Your password here
        sendmail.setTo("liyuhang@bupt.edu.cn");
        sendmail.setFrom("wangyedongman@163.com");
        sendmail.setSubject("Warning, good are ruining!");
        sendmail.setContent("Warning, goods are ruining!");
        // Mail sendmail = new
        // Mail("dujiang@sricnet.com","du_jiang@sohu.com","smtp.sohu.com","du_jiang","31415926","你好","胃，你好吗？");
        sendmail.attachfile("C:\\Users\\Lenovo\\Documents\\2019-2020\\IoT lab\\coursework\\image\\mail.png");
        sendmail.attachfile("C:\\Users\\Lenovo\\Documents\\2019-2020\\IoT lab\\coursework\\image\\mail.png");
